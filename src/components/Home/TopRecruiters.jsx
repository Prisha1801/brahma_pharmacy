...
const recruiters = [
    { name: "Apollo", file: "apollo.jpg", sector: "Healthcare" },
    { name: "HDFC Bank", file: "hdfc bank.jpg", sector: "Banking" },
    { name: "ICICI Bank", file: "icici bank.jpg", sector: "Banking" },
    { name: "Quick Heal", file: "quick heal.jpg", sector: "Cybersecurity" },
    { name: "SBI", file: "sbi.jpg", sector: "Banking" },
    { name: "TCS", file: "tcs.jpg", sector: "IT Services" },
    { name: "UMS Tech", file: "ums tech.jpg", sector: "Technology" }
];
    ...
    return (
        <>
            ...
            >
                ...
                <div className="relative z-10 max-w-6xl mx-auto px-8 text-center mb-12">
